...
public class Analysis {
	...
	public static void main(String[] args) throws Exception {
		...
		//file name strings
		String weightValues = new String ("Year3_Project/Documents/Evaluation/Monthly Analysis Results/6-4/weightValueSplitSet.csv");
		String biasValues = new String ("Year3_Project/Documents/Evaluation/Monthly Analysis Results/6-4/biasValueSplitSet.csv");
		String evalAvgs = new String ("Year3_Project/Documents/Evaluation/Monthly Analysis Results/6-4/meanErrorsSplitSet2.csv");
		String randomWeights = new String ("Year3_Project/Documents/Evaluation/Monthly Analysis Results/6-4/Request_analysis_randomWeights.csv");
		String randomBias = new String ("Year3_Project/Documents/Evaluation/Monthly Analysis Results/6-4/Request_analysis_randomBias.csv");
		...
		nn.NeuralNetworkGo();
		nn.readBias(biasValues);
		nn.readWeights(weightValues);
